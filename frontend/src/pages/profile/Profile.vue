              ...
              <div>
                ...
                <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                    <!-- profile picture -->
                    <div class="flex">
                      <img class="h-24 w-24 rounded-full ring-4 ring-white sm:h-32 sm:w-32" src="../../assets/profile_pic.png" alt="">
                    </div>
...
export default {
  ...
  methods: {
    async fetchUserDetails() {
      try {
        this.userDetails = {};
        let peopleDict = this.$store.state.people.peopleDict;
        const userDetails = peopleDict[this.userId];
